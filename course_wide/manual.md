...
| Day | Reading |
| --- | ------- |
| 2 | [Media for Thinking the Unthinkable (Victor 2013)](https://vimeo.com/67076984) |
| 3 | [Dealing with Open Source Licenses (Winslow 2019)](https://docs.google.com/presentation/d/1qF9MHkp0p6THLU1bXPV7snaKTMYwYWH0RqxL7v0bJ8Y/edit?usp=sharing) |
| 4 | [A Byte of Python (Swaroop 2023)](https://python.swaroopch.com) |
| 5 | [Review of Tufte's "The Visual Display of Quantitative Information" (LeRoy 2018)](https://benjaminleroy.github.io/pages/blog/public/post/2018/05/16/review-of-tufte-s-the-visual-display-of-quantitative-information/) |
| 6 | [Preattentive Attributes in Visualization (Kesavan 2016)](https://daydreamingnumbers.com/blog/preattentive-attributes-example/) |
| 7 | [Inventing on Principle (Victor 2012)](https://www.youtube.com/watch?v=PUv66718DII) |
| 8/9 | [Genuary](https://genuary.art/) |
| 10 | [All Maps are Wrong (Harris 2016)](https://www.youtube.com/watch?v=kIID5FDi2JQ) |
| 11 | [How William Cleveland Turned Data Visualization Into a Science (Pricenomics 2016)](https://priceonomics.com/how-william-cleveland-turned-data-visualization/) |
| 12 | [From Data to Viz (Holtz 2018)](https://www.data-to-viz.com/) |
| 13 | [Lupi and Posavec (2015)](https://vimeo.com/channels/eyeo2015/133608605) |
| 14 | [15 Views on a Node Link Graph (Munzner 2007)](https://www.youtube.com/watch?v=WOBKnRlOAes) |
| 15 | [Designing for Realtime Spacecraft Operations (Binx 2016)](https://www.youtube.com/watch?v=HiGd-JJ94QA) |
| 16 | [It's Not You, Bad Doors are Everywhere (Posner et al 2016)](https://www.youtube.com/watch?v=yY96hTb8WgI) |
| 17 | [The Role of the Player (Portnow 2011)](https://www.youtube.com/watch?v=ulm7bcB2xvY), [Explorable Explanations (Victor 2011)](https://worrydream.com/ExplorableExplanations/) |
| 18 | [The Last Guardian and the Language of Games (Brown 2017)](https://www.youtube.com/watch?v=Qot5_rMB8Jc) |
| 19 | [Super Mario Bros: Level 1-1 (Edmonds and Portnow 2014)](https://www.youtube.com/watch?v=ZH2wGpEZVgE), [Triangle Design (Brown 2023)](https://www.youtube.com/watch?v=CZzcVs8tNfE&themeRefresh=1). |
| 21 | [Storytelling with Verbs (Tremblay 2020)](https://www.youtube.com/watch?v=ontNUxSLhb8). [Spore, birth of a game (Wright 2007)](https://www.ted.com/talks/will_wright_spore_birth_of_a_game?language=en) |
| 22 | [Games are for Everyone (Brown 2018)](https://www.youtube.com/watch?v=xrqdU4cZaLw) |
| 23 | [Here's What Ethical AI Really Means (Thorne 2023)](https://www.youtube.com/watch?v=AaU6tI2pb3M) or [Sasha Costanza-Chock (2019)](https://vimeo.com/354276956) |
| 24 | [The World Design of Metroid 1 and Zero Mission (Brown 2018)](https://www.youtube.com/watch?v=kUT60DKaEGc) |
...
**[Cosmic Wheel (Deconstructteam 2023)](https://cosmicwheel.com/)** ⚔️ ❤️ 📱
- How do the player and game respond to each other?
- To what degree does the player have agency over the narrative?

**[FTL (Ma and Davis 2012)](https://subsetgames.com/ftl.html)** ⚔️ 📱
...
**[Unpacking (Brier et al 2021)](https://www.witchbeam.com.au/unpacking)** ⏱️ ❤️ 📱
- Would the game be different with dialogue?
- How does the game use solution validity to build its narrative?

**[Afterplace (Kice 2022)](https://afterplace.game/)** ⚔️ ❤️ 📱
...
### Motivation
Some assignments require coding but others may, for example, be drawing or short writings. Though we provide instruction in [Sketchingpy (Pottinger 2024)](https://sketchingpy.org), alternative technologies may be used if desired. The details of each assignment are provided below. These are due 2 days after lecture date below. There are 14 of these short assignments in total for 28 expected hours.
...
Please write 4 - 8 sentences. See [Lesson 3](/mooc/lesson3.html) for more details.

#### Assignment 4: Example visualization 2
Find another visualization but, this time, limit yourself to just the sources types provided by Sam (see the list in [Lesson 5](/mooc/lesson5.html)). What is the intended message? How does the visualization convey this message? What might the 4 perspectives say about this visualization? Please post 4 - 8 sentences with a link.
...
Visualize 4 variables of the [income inequality dataset](https://incomegaps.com/) (Pottinger 2023) with a design guided by the recent course material. Please make this version without interactivity. Post your code and a screenshot!
...
This resource provides an imperfect but multi-faceted look at working experiences within tech, spanning pay to technical preferences and satisfaction. It contains many interesting stories ([Stack Exchange 2024](https://survey.stackoverflow.co/)).

#### California State Budget
Explore government through how it allocates its limited resources. The California State Budget provides another lens into our home and our representatives ([California Department of Finance 2026](https://ebudget.ca.gov/)).

#### Amtrak Ridership Data
People travel for a lot of reasons. This look into mobility charts the path of those stories across America, winding through big cities and small towns along the way. What can you uncover? ([Bureau of Transportation Statistics 2024](https://www.bts.gov/browse-statistical-products-and-data/state-transportation-statistics/amtrak-ridership)).

#### EPI Microdata (US ACS)
With a nearly overwhelming number of variables, the census ACS understands American life through rich socioeconomic data. It paints complex pictures of diverse experiences ([Economic Policy Institute 2025](https://microdata.epi.org/)).

#### US State Energy Data System
Electricity underpins our society. What consumes power and from what sources reflects climate priorities, economic forces, and social preferences. Each kilowatt adds to a bigger story ([U.S. Energy Information Administration 2024](https://www.eia.gov/state/seds/)).

#### Armed Conflict Location and Event Data
Conflict shapes the course of human history and remains an ongoing force in our world today. What can a data perspective on these conflicts tell us about our species and our future? ([ACLED 2025](https://acleddata.com/)).

#### Global Plastics AI Policy Tool
Plastics pollution sits in between ecological destruction and fossil fuels contributing to climate change. What can plastic tell us about our environmental future? ([Pottinger et al. 2024](https://global-plastics-tool.org/)).

#### Climate Driven Doubling of Maize Loss
Agriculture is under stress from climate change. What can exploring the future of corn in the US tell us about our challenges and our adaptation opportunities? ([Pottinger et al. 2025](https://doi.org/10.52933/jdssv.v5i3.134)).

#### AFSC GAP
Climate change is impacting fisheries. What can fish stocks data tell us about climate and food? ([Pottinger and Zarpellon 2023](https://pyafscgap.org/)).

#### GitHut
What can programming language popularity tell us about shifting trends in tech? ([GitHut 2024](https://madnight.github.io/githut/)).
...
#### Auditing resources
As the course is taught, updated rehearsal recordings will be posted online shortly after the lecture is delivered in class. These will have manually reviewed captions and will be publicly available. Please join us in the Zulip community to receive notifications when lectures and their corresponding reading assignments become accessible. Finally, those auditing are welcome to join in person. However, if space is limited, seats will be prioritized for those attending for credit. My apologies!
...
### Final projects for UC Berkeley community
