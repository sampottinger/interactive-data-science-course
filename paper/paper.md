...
# Statement of Need
Through hands-on projects, these open source educational materials aim to empower students to critically design interactive digital media for interrogating data. However, going beyond traditional introductory information design instruction, these materials also explore the implementation of these rich bespoke interactive computational experiences as made possible through custom programming^[Taught in Python, adaptable to other languages.]. Altogether, these resources situtate design techniques within engineering instruction as necessary for building media for thought [@VictorMedia].
